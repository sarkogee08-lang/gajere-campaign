  ...
  useEffect(() => {
    async function fetchGallery() {
      ...
      if (error) {
        ...
        console.error("Gallery Error Details:", error.details);
        console.error("Gallery Error Hint:", error.hint);
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-600">
            ...
            listening to communities, and building a shared vision for the
            future.
          </p>
        </div>
        ...
        {!loading && !errorMessage && gallery.length === 0 && (
          <div className="mt-16 rounded-2xl bg-gray-50 p-8 text-center">
